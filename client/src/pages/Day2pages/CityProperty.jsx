...
export default function FlatCards() {
  ...
  // Filter properties by location area
  const propertiecitywise = properties.filter(
    (property) => property.location.area?.toLowerCase() === city?.toLowerCase()
  );
  console.log(city);
  ...
  return (
    <>
      ...
      <div className="space-y-4">
        {propertiecitywise.map((property, index) => (
